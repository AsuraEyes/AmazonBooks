...
db.books.update({ _id: books_ids.RG }, { $push: { categories: categories_ids.SO } })
db.books.update({ _id: books_ids.GP }, { $push: { categories: categories_ids.HSF } })
db.books.update({ _id: books_ids.RPG }, { $push: { categories: categories_ids.AH } })
db.books.update({ _id: books_ids.TTB }, { $push: { categories: categories_ids.CTM } })
db.books.update({ _id: books_ids.IB }, { $push: { categories: categories_ids.TH } })
db.books.update({ _id: books_ids.HP }, { $push: { categories: categories_ids.EL } })
db.books.update({ _id: books_ids.LOTB }, { $push: { categories: categories_ids.SS } })
db.books.update({ _id: books_ids.GB }, { $push: { categories: categories_ids.SS } })
db.books.update({ _id: books_ids.TW }, { $push: { categories: categories_ids.ML } })
db.books.update({ _id: books_ids.BK }, { $push: { categories: categories_ids.FA } })